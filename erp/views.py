...
def home(request: HttpRequest):
    ...
    return render(request, "home.html", {"page_title": "Home", "root_cost_centers": root_cost_centers})
...
def cost_center(request: HttpRequest, i: int):
    ...
    return render(
        request, "cost_center.html", {"page_title": cc.name, "cost_center": cc}
    )


def balance_sheet(request: HttpRequest):
    p = (
